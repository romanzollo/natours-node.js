...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if (bookBtn) // если кнопка найдена, добавляем обработчик клика
    bookBtn.addEventListener('click', async (e)=>{
        ...
        try {
            const res = await (0, _axiosDefault.default).post(`/api/v1/bookings/checkout-session/${tourId}`); // отправляем запрос на создание платежа
            const confirmationUrl = res.data?.session?.confirmation_url; // получаем confirmation_url из ответа
            if (!confirmationUrl) throw new Error('YooKassa confirmation URL was not returned by API.'); // если confirmation_url не получен, выбрасываем ошибку
            ...
            if (res.data?.session?.id) // если id платежа получен, сохраняем его в localStorage
            ...
            (0, _alertsJs.showAlert)('error', err.response?.data?.message || err.message || 'Could not start payment. Please try again.');
...
},{"./map.js":"3LfOV","axios":"9QTOy","./alerts.js":"5ZxnT","@parcel/transformer-js/src/esmodule-helpers.js":"cGvcY"}],"3LfOV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"9QTOy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"cGvcY"}],"45Ih6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"cGvcY"}]},["i7Ffa"], "i7Ffa", "parcelRequire2b78", {})
